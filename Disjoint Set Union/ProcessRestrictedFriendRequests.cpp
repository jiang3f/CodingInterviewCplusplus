    ...
    public:
        ...
        vector<bool> friendRequests(int n, vector<vector<int>>& restrictions, vector<vector<int>>& requests)
        {
            ...
            for (auto& request : requests)
            {
                ...
                int px = dsu.find_set(x);
                int py = dsu.find_set(y);
                ...
                {
                    int rx = dsu.find_set(restriction[0]);
                    int ry = dsu.find_set(restriction[1]);
...
int ProcessRestrictedFriendRequests_Test()
{
    ...
    vector<bool> rets = ob.friendRequests(5, restrictions, requests);
